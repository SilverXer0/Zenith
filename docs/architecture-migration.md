...
| Planning intelligence | Node and Python task/calendar morning and weekly views; Python/Next now adds local-timezone availability windows and overlapping-event conflicts | Real-device checks and richer task-duration recommendations |
