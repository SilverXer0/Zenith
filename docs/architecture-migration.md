...
| Planning intelligence | Node and Python task/calendar morning and weekly views; target frontend shows task focus, weekly plan, and daily completion summary | Timezone-aware availability/conflict planning and answer-quality checks |
