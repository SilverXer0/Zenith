...
| Planning intelligence | Node task focus, morning/weekly/summary endpoints; calendar context | Timezone-aware availability/conflict planning and answer-quality checks |
| Persistent context | User-managed SQLite notes included in assistant context | Python API/UI parity and verification of useful ongoing context |
